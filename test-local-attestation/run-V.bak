...
if [ -f "kii_0.log" ]; then
    rm "kii_0.log"
    echo "kii_0.log removed successfully."
else
    echo "kii_0.log does not exist."
fi

if [ -f "kii_1.log" ]; then
    rm "kii_1.log"
    echo "kii_1.log removed successfully."
else
    echo "kii_1.log does not exist."
fi

echo Clearing and Initializing Player-Data
...
echo Running CRG for $KII_PLAYER_COUNT players.
...
for (( i = KII_PLAYER_COUNT - 1; i >= 0; i-- )); do
    ...
    (   
        ...
        #echo Starting Verifier i.e. KII $i in background mode.
