...
mr_enclave="cc337a316936cc3fadea9362f591f8b87965592295b5a2eb9c172bdf76f33807"
mr_signer="581e423ea8652f4e7c4d2ef0366970617f739fa39bffe027f5e619a22103dccf"
...
for (( i = KII_PLAYER_COUNT - 1; i >= 0; i-- )); do
    ...
    # (   
        ...
        # ./KII "$mr_enclave" "$mr_signer" 0 0 $i >> "kii_${i}.log" 2>&1 &
          ./KII "$mr_enclave" "$mr_signer" 0 0 $i 
