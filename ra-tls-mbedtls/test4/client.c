...
// extern ra_tls_verify_callback_extended_der_f ra_tls_verify_callback_extended1_der_f;
...
static int my_verify_callback(void* data, mbedtls_x509_crt* crt, int depth, uint32_t* flags) {
    ...
    if (ra_tls_verify_callback_extended1_der_f) {
...
int ssl_client_setup_and_handshake(
    ...
    for (other_player_number = number_of_players - 1;
        ...
        msg.player_number = other_player_number;                // Example initialization
