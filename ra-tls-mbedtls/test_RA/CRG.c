...
int main(int argc, char** argv) {
    ...
    printf("####################%s", Player_MAC_Keys_p[0]);
    printf("%s", Player_MAC_Keys_2[0]);
    printf("%s", Player_MAC_Keys_p[1]);
    printf("%s", Player_MAC_Keys_2[1]);
    // Player_MAC_Keys_p = {"-88222337191559387830816715872691188861", "1113507028231509545156335486838233835"};
    // Player_MAC_Keys_2 = {"f0cf6099e629fd0bda2de3f9515ab72b", "c347ce3d9e165e4e85221f9da7591d98"};
    // printf("******************\n%s", Player_MAC_Keys_p[0]);
    // printf("%s", Player_MAC_Keys_2[0]);
    // printf("%s", Player_MAC_Keys_p[1]);
    // printf("%s", Player_MAC_Keys_2[1]);
