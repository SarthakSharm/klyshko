...
int ssl_client_setup_and_handshake(char* a, char* b, char* c, char* d, char *Player_MAC_Keys_p[],
    ...
    for (other_player_number = number_of_players - 1;
        ...
        printf(" !!! WE ARE WRITING THIS:\n%s", Player_MAC_Keys_2[0]);
        printf(" !!! WE ARE WRITING THIS:\n%s", Player_MAC_Keys_p[0]);

        message.mackeyshare_2 = Player_MAC_Keys_2[0];
        message.mackeyshare_p = Player_MAC_Keys_p[0];
        message.seeds         = Seed;
        ...
        Player_MAC_Keys_p[1] = secret_message->mackeyshare_p;
        Player_MAC_Keys_2[1] = secret_message->mackeyshare_2;
